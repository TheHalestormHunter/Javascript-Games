...
function onLoad() {
  ...
  document.getElementById("wins").src = "resources/Space Cadet/Game blank.png";  
  document.getElementById("loss").src = "resources/Space Cadet/Game blank.png";
...
function check(mineButton, depth) {
  ...
  if(firstClick && depth==0 && gamePause) { // prevents bomb on first click
...
function pause(){ 
  ...
  if(gameOn && gamePause && currentTime == 0) {
    location.reload();
  }
   else if(currentTime != 0 && gamePause && !gameOn) {
	gameLost();
    location.reload();
  } else {
      if(gameOn && gamePause && currentTime != 0){
...
function newHighScore() {
	...
	document.getElementById("sFace").src = "resources/face/space/blankface.png";
	document.getElementById("sBoard").src = "resources/Space Cadet/Space Cadet Modified empty.png";
	document.getElementById("sShip").src = "resources/Space Cadet/ship3.1.png";
	if(difficulty == 0) document.getElementById("spaceShip").style.animation = "spaceFlight 2s 1";
	if(difficulty == 1) document.getElementById("spaceShip").style.animation = "spaceFlight1 2s 1";
    if(difficulty == 2) document.getElementById("spaceShip").style.animation = "spaceFlight2 2s 1";
	if(difficulty == 3) document.getElementById("spaceShip").style.animation = "spaceFlight3 2s 1";
    setTimeout(resetBoard,2000);
}

function resetBoard() {
	document.getElementById("sBoard").src = "resources/Space Cadet/Space Cadet Modified.png";
	document.getElementById("sShip").src = "resources/Space Cadet/blankShip.png";
	document.getElementById("spaceShip").style.animation = "nothing";
}
...
function explode(){
	var delay = setInterval(exploder, 100)
	
	clearInterval(exploder);
}

function exploder(){
	if(planet < 7){
	planet++;
	document.getElementById("sPlanet").src = "resources/Explosion/Planet" + planet + ".png";
	console.log(planet);
	}
}
